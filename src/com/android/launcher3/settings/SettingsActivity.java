...
import com.android.launcher3.eunoia.trust.TrustAppsActivity;
    ...
    public static class LauncherSettingsFragment extends PreferenceFragmentCompat implements
        ...
        protected boolean initPreference(Preference preference) {
            switch (preference.getKey()) {
                ...
                case KEY_MINUS_ONE:
                    return EunoiaUtils.isPackageEnabled(getActivity(), SEARCH_PACKAGE);

                case KEY_TRUST_APPS:
                    preference.setOnPreferenceClickListener(p -> {
                        EunoiaUtils.showLockScreen(getActivity(),
                ...
                case KEY_SUGGESTIONS:
                    return EunoiaUtils.isPackageEnabled(getActivity(), SUGGESTIONS_PACKAGE);
            }
